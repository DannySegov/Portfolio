            ...
            <div className="flex flex-col lg:items-center">
                <div className="relative w-full max-w-4xl rounded-[20px] sm:rounded-[30px] px-2 py-2 overflow-visible shadow-xl bg-blueCard border border-blueCardLight">
                    <form className="p-7">
                        ...
                        <button type="button" className="w-full border border-gray-300 focus:outline-none active:bg-gray-200/10 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">
                            Enviar
                        </button>
                    </form>
                </div>
